...
function gfeat; _gcm "feat" ":sparkles:" $argv; end;
function gfix; _gcm "fix" ":bug:" $argv; end;
function gperf; _gcm "perf" ":zap:" $argv; end;
function gchore; _gcm "chore" ":wrench:" $argv; end;
function grefactor; _gcm "refactor" ":recycle:" $argv; end;
function gstyle; _gcm "style" ":art:" $argv; end;
function gdocs; _gcm "docs" ":pencil:" $argv; end;
